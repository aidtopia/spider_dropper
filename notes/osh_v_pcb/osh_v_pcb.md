...
The first problem, according to the rep, was that the system automatically creates an account for you when you place your first order.  Supposedly it leaves you logged into this new account.  There's no indication of this in the user interface.  The order confirmation page still had a "Log In / Sign Up" link at the top, I'd never been asked to agree to a terms of service, and I was never prompted to create a password.  According to the rep, when I tried to create an account, it failed because I already had an account and, supposedly, I was already logged in.
