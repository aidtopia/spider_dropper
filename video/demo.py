...
def generate_frame(n, angle=0):
    command = f"openscad -o frame{n:05d}.png -D \"Motor_Angle={angle}\" -D \"Motor_Type=\"\"Reindeer\"\"\" -D \"Preview_Motor=true\" --camera 20,-150,400,20,0,0 --imgsize=1920,1080 --colorscheme=\"Tomorrow Night\" ..\parts\spider_dropper.scad"
    print(f"$ {command}\n")
